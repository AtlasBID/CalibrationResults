...
title = "Paper 2012 B-Tagging SF Results for Jung Tests"
name = "2012-Paper-Jung"
description = "Final 2011 results for dijet and ttbar, for the b-tagging paper, using only ttbar kinematic selection in dilepton events for ttbar fits"
...
analysisGroupings = {
    'bottom': {
		'dijet': ["pTrel", "system8"],
		'all': ["ttbar_kinsel_dilep", "pTrel", "system8"],
		},
	'light': {},
	'charm': {},
	'tau': {}
