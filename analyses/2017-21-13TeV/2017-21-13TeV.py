...
sfObject.restrict_good = lambda self: self.filter(
    taggers=taggers,
    jets=["AntiKt4EMTopoJets","AntiKt2PV0TrackJets","AntiKtVR30Rmax4Rmin02TrackJets","AntiKt4EMPFlowJets"],
    ).verify_OPs("21")
...
defaultSFs = master_cdi_file.make_cdi("MC16-CDI", "defaults.txt","cdi_eff_maps_Dec_20_2017.root","BTag_WP_Dec_8_2017.root","21")
