...
title = "2012 dataset noJVF B-Tagging SF Results"
...
inputs = [
    ...
    "DStar/noJVF/*.txt",
    "ptrel/noJVF/CharmTau/*.txt",

    "negativetag/noJVF/*topoEM_v3.txt",
    "negativetag/noJVF/*topoLC_v3.txt",
...
mcEffRootFile = [
    "TopCalibrations_rel17_MC12a_EM_Eff_nojvfCut_Convert.root",
    "TopCalibrations_rel17_MC12a_LC_Eff_nojvfCut_Convert.root",
    ]
